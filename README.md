Generated with [vike.dev/new](https://vike.dev/new) ([version 566](https://www.npmjs.com/package/create-vike/v/0.0.566)) using this command:

```sh
pnpm create vike@latest --vue --tailwindcss --daisyui --hono --kysely --biome
```
